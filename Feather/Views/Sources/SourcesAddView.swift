                ...
                VStack(spacing: 16) {
                        ...
                        if !validSources.isEmpty {
                                VStack(alignment: .leading, spacing: 12) {
                                        ...
                                        .clipShape(RoundedRectangle(cornerRadius: 12, style: .continuous))
                                        .shadow(color: themeManager.selectionColor.opacity(0.4), radius: 12, x: 0, y: 6)
                                }
                                .padding(.horizontal)
                        }
                        ...
                        if !malformedSources.isEmpty {
                                VStack(alignment: .leading, spacing: 12) {
                                        ...
                                        .clipShape(RoundedRectangle(cornerRadius: 12, style: .continuous))
                                        .shadow(color: themeManager.destructiveColor.opacity(0.4), radius: 12, x: 0, y: 6)
                                }
                                .padding(.horizontal)
                        }
                }
        ...
        private func _exportSelectionSection() -> some View {
                ...
                VStack(alignment: .leading, spacing: 20) {
                        Menu {
                                ...
                                .background(
                                        LinearGradient(
                                                colors: [themeManager.buttonBackgroundColor, themeManager.accentColor.opacity(0.9)],
                                                startPoint: .leading,
                                                endPoint: .trailing
                                        )
                                )
